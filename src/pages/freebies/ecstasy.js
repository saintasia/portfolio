...
const Ecstasy = () => (
  <>
    <Seo
      title={`Anastasia Kashkinova - Product Designer & UX Engineer | Freebies | Ecstasy FitBit Face`}
    />
    ...
    <div class="Container-slim">
      <p>
        Free FitBit Versa watch face. Developed with FitBit SDK.
        <br />
        <br />
        <a
          className="text-link"
          href="https://gallery.fitbit.com/details/641e0692-06a9-41d2-8654-61b8fba6b5e7"
    ...
    <img
      ...
      src="/images/ecstasy/details.png"
    />
  </>
)
