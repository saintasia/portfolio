...
const IndexPage = ({ data }) => {
  ...
  return (
    <>
      <Seo title="Anastasia Kashkinova - Product Designer & UX Engineer | Home" />
      <ParallaxProvider>
        <section>
          <div className="Hero">
            <div className="Hero__text">
              <Parallax y={parallaxValue}>
                <Fade bottom>
                  ...
                  <p>
                    Hi, I’m Anastasia - a Product Desginer based in Melbourne. I
                    specialize in <b>UI/UX design</b>, <b>design systems</b> and{" "}
                    <b>front-end engineering</b>.
                  </p>
                  <p>
                    Feel free to connect with me via my social profiles or to{" "}
                  ...
                  <ul className="Hero__social">
                    <li>
                      <a
                        href="https://dribbble.com/saintasia"
                    ...
                    <li>
                      <a
                        href="https://codepen.io/saintasia/"
                        rel="noopener noreferrer"
                        target="_blank"
                        aria-label="codepen"
                      >
                    ...
                    <li>
                      <a
                        href="https://github.com/saintasia"
                        rel="noopener noreferrer"
                        target="_blank"
                        aria-label="github"
                      >
                    ...
                    <li>
                      <a
                        href="https://medium.com/@saintasia"
                        rel="noopener noreferrer"
                        target="_blank"
                        aria-label="medium"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.linkedin.com/in/saintasia/"
                        rel="noopener noreferrer"
                        target="_blank"
                        aria-label="linkedin"
                      >
        ...
        <section className="Works">
          <div className="Works__gridItemText">
            ...
            <Fade bottom>
              <Link className="forward-link Works__gridItemLink" to="/works">
          ...
          <div className="Container__overflow">
            <div className="Works__grid">
              {data.WorksIndexQuery.edges.map(
                work =>
        ...
        <section className="Works">
          <div className="Works__gridItemText">
            ...
            <Fade bottom>
              <Link
                className="forward-link Works__gridItemLink"
                to="/experiments"
              >
                See all <FaArrowRight />
              </Link>
        ...
        <section className="Works">
          <div className="Works__gridItemText">
            ...
            <Fade bottom>
              <Link className="forward-link Works__gridItemLink" to="/freebies">
                See all <FaArrowRight />
              </Link>
            </Fade>
          </div>
