...
const AboutPage = () => (
  <Layout>
    ...
    <div className="Main__Container">
      ...
      <p>Most of my experience lies in hybrid designer/developer positions, I just love doing both and strive to do my best whether I'm using my "creative" or "logical and problem" capabilities, I also believe <b>design and development go hand-in-hand and should not be treated like two separate entities</b>.
